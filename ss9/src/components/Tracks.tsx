...
const Tracks = () => {
  return (
    <>
        <div className='p-10 md:p-40 m-10 md:m-40 bg-white bg-opacity-5 rounded-2xl backdrop-blur-md'>
        <h1  className='text-white  text-[2rem] md:text-[4rem] text-center mb-12'>TRACKS</h1>
